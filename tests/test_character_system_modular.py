"""
Unit Tests for Character System - Modular Version
Tests for the new modular character system using core.models and core.engine
"""

import pytest
import uuid
from core.models import Character, CharacterClass, CharacterStats, GameState
...
class TestGameEngine:
    ...
    def test_start_new_game(self):
        ...
        assert engine.game_state.player is not None
    ...
    def test_game_status(self):
        ...
        assert "player" in status["game_state"]
