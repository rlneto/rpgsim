...
class QualityChecker:
    ...
    def _run_bdd_tests_for_system(
        self, system_name: str, verbose: bool = False
    ) -> bool:
    ...
    def _run_unit_tests_for_system(
        self, system_name: str, verbose: bool = False
    ) -> bool:
        ...
        try:
            result = subprocess.run(
                [
                    ...
                    "-m",
                    "pytest",
                    f"tests/unit/test_{system_name}.py",
                    f"--cov=core.systems.{system_name}",
                    "--cov-report=term-missing",
                ],
                cwd=self.project_root,
                capture_output=True,
