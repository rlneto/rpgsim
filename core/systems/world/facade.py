...
from .domain.world import World, Location, TravelConnection, DEFAULT_WORLD_CONFIG
...
class WorldSystem:
    ...
    def get_locations_in_range(self, center_location_id: str, max_distance: float, character_data: Dict) -> List[Dict]:
        ...
        return self.location_service.get_locations_in_range(center_location_id, max_distance, character_data)
    ...
    def can_travel(self, from_location_id: str, to_location_id: str, character_data: Dict) -> bool:
        ...
        return self.travel_service.can_travel(from_location_id, to_location_id, character_data)
    ...
    def calculate_travel_time(self, from_location_id: str, to_location_id: str, character_data: Dict) -> int:
        ...
        return self.travel_service.calculate_travel_time(from_location_id, to_location_id, character_data)
    
    def find_route(self, from_location_id: str, to_location_id: str, character_data: Dict) -> Optional[Dict]:
        """Find best route between two locations"""
        route = self.travel_service.find_route(from_location_id, to_location_id, character_data)
    ...
    def get_available_destinations(self, from_location_id: str, character_data: Dict) -> List[Dict]:
        ...
        return self.travel_service.get_available_destinations(from_location_id, character_data)
    ...
    def calculate_distance(self, from_location_id: str, to_location_id: str) -> Optional[float]:
        ...
        return self.location_service.calculate_distance(from_location_id, to_location_id)
...
def can_travel(from_location_id: str, to_location_id: str, character_data: Dict) -> bool:
...
def find_route(from_location_id: str, to_location_id: str, character_data: Dict) -> Optional[Dict]:
...
__all__ = [
    'WorldSystem',
    'get_world_info', 'get_starting_location', 'get_location_details',
    'can_travel', 'find_route', 'advance_time', 'get_current_time'
]
