...
from core.models import Character, CharacterClass, Quest, Enemy, Item
from core.validation import ValidationError
from core.constants import (
    GAME_CONFIG, ABILITY_LEARNING_SCHEDULE
)
...
def get_experience_for_level(level: int) -> int:
    ...
    # Level 2: 100, Level 5: 1000, Level 10: 4000, Level 20: 16000, Level 50: 100000, Level 100: 400000
    if level <= 20:
...
def calculate_level_up_bonuses(
    ...
    from .stats import calculate_base_hp
    old_max_hp = character.max_hp
    new_max_hp = calculate_base_hp(character.class_type, character.stats.constitution, new_level)
