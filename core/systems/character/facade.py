...
from .services.character_service import (
    CharacterCreationService, CharacterProgressionService,
    CharacterInventoryService, CharacterBalanceService
)
from .repositories.memory_repository import MemoryCharacterRepository
from .exceptions.character_exceptions import (
    InvalidCharacterClassError, CharacterCreationError,
    CharacterNotFoundError, InventoryError
)
...
class CharacterSystem:
    ...
    def create_character(self, name: str, class_type: str) -> Character:
        ...
        if not character.created:
            raise CharacterCreationError(f"Failed to create character: {name} ({class_type})")
