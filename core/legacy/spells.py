...
from core.models import Character, CharacterStats, Enemy, GameState
...
def calculate_spell_damage(
    ...
    # Define spell schools configuration
    spell_schools = {
        "fire": {
...
def calculate_spell_cost(
    spell_name: str, spell_school: str, spell_power: int, caster_level: int = 1
) -> Dict[str, Any]:
    """
...
def _get_spell_resistance(target: Union[Character, Enemy], spell_school: str) -> float:
...
def _get_spell_configuration(
    spell_name: str, spell_school: str
