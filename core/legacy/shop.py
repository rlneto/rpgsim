...
class TransactionDetails:
    """Transaction pricing and quantity details"""
...
class ShopTransaction:
    ...
    def get_transaction_summary(self) -> Dict[str, Any]:
        ...
        return {
            "transaction_id": self.info.transaction_id,
            "shop_id": self.info.shop_id,
            "item_name": self.info.item_name,
            "type": self.info.transaction_type,
            "quantity": self.info.details.quantity,
            "total_price": self.info.details.total_price,
            "timestamp": self.info.details.timestamp,
        }
...
def buy_item_from_shop(shop_id: str, item_id: str) -> Dict[str, Any]:
...
def sell_item_to_shop(shop_id: str, item: ShopItem) -> Dict[str, Any]:
...
def restock_shop() -> Dict[str, Any]:
    """Restock shop (backward compatibility)"""
    return {"success": True, "message": "Shop restocked"}


def calculate_shop_prices(shop_id: str, base_prices: List[int]) -> List[int]:
    """Calculate shop prices (backward compatibility)"""
    shop = _shop_system.get_shop(shop_id)
    return [int(price * shop.economy.quality_modifier) for price in base_prices]


def update_shop_economy(shop_id: str, economic_change: int) -> Dict[str, Any]:
...
def generate_shop_inventory() -> List[ShopItem]:
