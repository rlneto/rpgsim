...
from .ui.modular_ui import (
    UISystem, get_ui_system, initialize_ui, run_ui, 
    log_message, GameState, UIState, MessageType
)
from .ui.domain.ui import (
    UISession, LogMessage, ColorScheme, 
    ScreenPosition, ScreenSize, MenuItem
)
...
from .ui.screens.modern_terminal_ui import (
    ...
    create_terminal_ui, run_terminal_ui
)
...
class ModernTerminalUI:
    ...
    def set_game_state(self, player_data: Dict[str, Any], 
...
def create_terminal_ui():
    """Legacy function - creates modular UI"""
    return create_modern_ui().ui_system.ui_app


def run_terminal_ui():
    """Legacy function - runs modular UI"""
...
__all__ = [
    ...
    'create_modern_ui',
    'run_modern_terminal_ui',
    'create_terminal_ui',  # Legacy
    'run_terminal_ui',    # Legacy
    'UISystem',
    'get_ui_system',
    'initialize_ui',
    'run_ui',
